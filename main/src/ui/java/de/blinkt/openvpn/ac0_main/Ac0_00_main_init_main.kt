...
import de.blinkt.openvpn.databinding.Ais03MainMainBinding

class Ac0_00_main_init_main : ComponentActivity() {
    lateinit var binding: Ais03MainMainBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding=  Ais03MainMainBinding.inflate(layoutInflater)
